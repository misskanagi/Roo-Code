...
function asObjectSafe(value: any): object {
	...
	try {
		...
		console.warn("Roo Code Paper <Language Model API>: Failed to parse object:", error)
		return {}
	}
}
...
export async function convertToAnthropicMessage(
	...
	if (anthropicRole !== "assistant") {
		throw new Error("Roo Code Paper <Language Model API>: Only assistant messages are supported.")
	}
