...
const Announcement = ({ version, hideAnnouncement }: AnnouncementProps) => {
	return (
		<div
			...
			<h2 style={{ margin: "0 0 8px" }}>🎉{"  "}Introducing Roo Code Paper 3.2</h2>

			<p style={{ margin: "5px 0px" }}>
				Our biggest update yet is here - we're officially changing our name from Roo Cline to Roo Code Paper!
			...
			<p style={{ margin: "5px 0px" }}>
				To mark this new chapter, we're introducing the power to shape Roo Code Paper into any role you need!
			...
			<p style={{ margin: "5px 0px" }}>
				We can't wait to see how you'll push Roo Code Paper's potential even further! Share your custom modes
